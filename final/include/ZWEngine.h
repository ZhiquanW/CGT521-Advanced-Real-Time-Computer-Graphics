...
public:
  ...
  bool init_shader_program(const GLchar *, const GLchar *, const GLchar *);
...
void bind_vertex_buffer_object(const std::vector<GLfloat> &data,
                               GLenum data_type = GL_STATIC_DRAW);

void bind_vertex_attribute(GLuint index, GLint size, GLenum type,

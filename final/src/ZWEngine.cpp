...
bool ZWEngine::init_shader_program(const GLchar *vs_shader, const GLchar *fs_shader,const GLchar *cs_shader) {
    ...
    this->compute_shader_program = new ShaderProgram();
    this->compute_shader_program->attach_shader("compute_shader",cs_shader);
    this->compute_shader_program->link_program();
